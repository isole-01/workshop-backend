...
public class FormController {
    ...
    @PostMapping("/create/{type}/{session_id}/{name}")
    public ResponseEntity<Form> createForm(@Nullable @PathVariable String name, @PathVariable FormType type, @PathVariable Long session_id, @RequestBody List<String> strings) {
