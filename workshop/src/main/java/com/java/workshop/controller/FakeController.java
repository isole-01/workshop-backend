...
public class FakeController {
    ...
    public void fake() {
        ...
        ArrayList<String> fnames = new ArrayList<>(Arrays.asList("Mammad", "Reza", "Ali", "Ahmad", "Dr", "Ali"));

        ArrayList<String> lnames = new ArrayList<>(Arrays.asList("Mammadian", "Rezaee", "Alizade", "Tohidi", "Sadri", "Hamze"));
        ...
        wks.setName("Basic Programming");
        wks.setPlace(placeRepository.findById((long) 1).get().getAddress());
        ...
        wks.setCachePrice(0);
        wks.setEndDate(new Date());
        wks.setStartDate(new Date());
        ...
        wks2.setName("Math");
        wks2.setPlace(placeRepository.findById((long) 2).get().getAddress());
        ...
        wks3.setName("Advanced Programming");
        wks3.setPlace(placeRepository.findById((long) 2).get().getAddress());
    ...
    public void fake2() {
        ...
        ArrayList<String> fnames = new ArrayList<>(Arrays.asList("Mammad"));

        ArrayList<String> lnames = new ArrayList<>(Arrays.asList("Mammadian"));
