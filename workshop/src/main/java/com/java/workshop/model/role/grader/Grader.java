...
public class Grader {
    ...
    public String getSessionName() {
        return this.group.getWorkshopSession().getName();
    }

    public Long getSessionId() {
        return this.group.getWorkshopSession().getId();
    }

    public Date getSessionStartDate() {
        return this.group.getWorkshopSession().getStartDate();
    }

    public Date getSessionEndDate() {
        return this.group.getWorkshopSession().getEndDate();
    }

    public String getInstructorName() {
        return this.group.getWorkshopSession().getInstructorName();
    }
}
